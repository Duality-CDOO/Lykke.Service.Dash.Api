...
namespace Lykke.Service.Sequence.Api.Helpers
{
    public static class Extenstions
    {
        ...
        public static WalletBalanceContract ToWalletBalanceContract(this IBalancePositive self)
        {
            return new WalletBalanceContract
            {
                ...
                AssetId = Asset.Sequence.Id,
                Balance = Conversions.CoinsToContract(self.Amount, Asset.Sequence.Accuracy),
                Block = self.Block
            };
        }
            ...
            bool isFrom)
        {
            ...
            {
                Amount = Conversions.CoinsToContract(amount, Asset.Sequence.Accuracy),
                AssetId = Asset.Sequence.Id,
